import { defaultTimeSettings, formatTimeDiff, getEventsInfo, updateEvents } from '../../common/time';
...
importBtn.addEventListener('click', async () => {
    ...
    else if (result.code === 'cancelled') showTranslatedToast('cancelled');
    else if (result.code === 'invalid-data') showTranslatedToast('toastImportInvalid', undefined, 'error');
    else showTranslatedToast('toastImportFailed', undefined, 'error');
});
